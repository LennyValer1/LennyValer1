...
```python
class Lenny(DataProfessional):
    # actualmente
    rol       = "Data Analyst @ Prestamype"
    enfoque   = "pipelines SQL · BI · analítica de crédito"
    # aprendiendo
    roadmap   = ["Data Engineering", "Data Science", "ML"]
    fun_fact  = "los datos cuentan historias 📈"
```
...
**📊 Datos & SQL**
![SQL](https://img.shields.io/badge/SQL-F29111?style=flat&logo=amazondynamodb&logoColor=white)
...
**🔗 Integraciones & Fuentes**
![HubSpot](https://img.shields.io/badge/HubSpot-FF7A59?style=flat&logo=hubspot&logoColor=white)
![SUNAT](https://img.shields.io/badge/SUNAT-API-red?style=flat)
![Sentinel](https://img.shields.io/badge/Sentinel-0078D4?style=flat&logo=microsoftazure&logoColor=white)

**🔬 Data Science**
![Scikit-learn](https://img.shields.io/badge/Scikit--learn-F7931E?style=flat&logo=scikitlearn&logoColor=white)
![Statistics](https://img.shields.io/badge/Statistics-8A2BE2?style=flat)
...
> 🟠 Analytics Engineering &nbsp; 🟡 Cloud Architecture &nbsp; 🩷 FinTech & Credit Risk
